...
## ck_playertimes -- not implemented in API
...
sql_stray_getSpawnPoints = "SELECT pos_x, pos_y, pos_z, ang_x, ang_y, ang_z FROM ck_spawnlocations WHERE mapname = '{}' AND zonegroup = 0;"
...
## check tables data type -- not implemented in API
...
# sql_selectBonusPR = "SELECT steamid, name, mapname, zonegroup, PRtimeinzone, PRcomplete, PRattempts, PRstcomplete FROM ck_prinfo WHERE steamid = '{}' AND mapname = '{}' AND zonegroup = '{}';" // duplicate of sql_selectPR
...
sql_stray_PRinfoByName = "SELECT steamid, name, mapname, runtime, PRtimeinzone, PRcomplete, PRattempts, PRstcomplete FROM ck_prinfo WHERE mapname LIKE '%{}%' AND zonegroup = {} AND steamid = '{}';"
